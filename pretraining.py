...
def main():
    ...
    trainer = SavePeftModelTrainer(
        ...
        compute_metrics=compute_metrics if training_args.do_eval and not is_torch_cuda_available() else None,
        preprocess_logits_for_metrics=preprocess_logits_for_metrics
        if training_args.do_eval and not is_torch_cuda_available()
        else None,
    )
